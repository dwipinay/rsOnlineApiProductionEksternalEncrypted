...
const apiDocBapeten1 = require('../documentations/apiDocsBapeten-1.json')
...
router.use('/apiDocBapeten-1', swaggerUi.serve, (req, res) => {
    let html = swaggerUi.generateHTML(apiDocBapeten1);
    res.send(html);
})
