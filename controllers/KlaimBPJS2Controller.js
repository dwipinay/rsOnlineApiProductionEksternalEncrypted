...
const KlaimBPJS2 = require('../models/KlaimBPJS2')
const pagination = require('../configs/Pagination')
const EKlaimUangMuka = require('../models/KlaimBPJS2')

class KlaimBPJS2Controller {
    index(req, res) {
        ...
        const KlaimBPJS2Object = new KlaimBPJS2()
        KlaimBPJS2Object.getData(req, (err, results) => {
            if (err) {
                res.status(422).send({
                    status: false,
                    message: err
...
module.exports = KlaimBPJS2Controller